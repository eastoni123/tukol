...
<head>
	...
	<title>Tukang Online | Eastoni</title>
...
<body class="grey lighten-5">
	<nav class="blue animated slideInDown delay5">
		<div class="nav-wrapper">
			...
			<ul id="nav-mobile" class="right hide-on-med-and-down">
				...
				<li class="animated rubberBand infinite"><a href="collapsible.html"><i class="zmdi zmdi-notifications"></i></a></li>
				<li id="btn-akun">
					<a>
						<div class="chip blue darken-2 white-text">
							<img src="../img/member/IMG_4536.JPG" alt="eastoni">
							Eastoni
						</div>
					</a>
				</li>
	...
	<div class="white z-depth-2" id="kotak-akun">
		<div class="row">
			<div id="foto-akun" style="background: url(../img/member/IMG_4536.JPG);" class="z-depth-2 col"></div>
			<div class="col m7">
				<h6 class="col m12">Nama : Eastoni</h6>
				<h6 class="col m12">Alamat : Singosari</h6>
				<h6 class="col m12">E-mail : ttoonnii321@gmail.com</h6>
			</div>
		</div>
